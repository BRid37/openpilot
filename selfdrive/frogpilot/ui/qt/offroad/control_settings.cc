    ...
    if (param == "AlwaysOnLateral") {
      ...
      if (param == "TrafficFollow" || param == "AggressiveFollow" || param == "StandardFollow" || param == "RelaxedFollow") {
        if (param == "TrafficFollow") {
          controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 0.10, 5, std::map<int, QString>(), this, false, tr(" seconds"), 1, 0.01);
        } else {
          controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 0.50, 5, std::map<int, QString>(), this, false, tr(" seconds"), 1, 0.01);
        }
      } else {
      ...
      controlToggle = customTorqueToggle;
    } else if (param == "SteerMax") {
      controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 200, 409, std::map<int, QString>(), this, false, "");
    } else if (param == "DeltaUp") {
      controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 1, 7, std::map<int, QString>(), this, false, "");
    } else if (param == "DeltaDown") {
      controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 1, 15, std::map<int, QString>(), this, false, "");
    } else if (param == "DriverAllowance") {
      controlToggle = new FrogPilotParamValueControl(param, title, desc, icon, 50, 450, std::map<int, QString>(), this, false, "");
