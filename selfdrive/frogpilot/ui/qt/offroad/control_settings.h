...
private:
  ...
  std::set<QString> qolKeys = {"MuteDM", "MuteDoor", "MuteSeatbelt", "CustomCruise", "CustomCruiseLong", "ForceStandstill", "MapGears", "PauseLateralSpeed", "ReverseCruise", "SetSpeedOffset"};
